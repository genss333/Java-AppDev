...
public class Ex12CarDAO {
	...
	public ArrayList<Ex12Car> viewCarsArrays() {
		...
		for(Object[] row : data) {
			...
			int rowplate = ((Integer)row[0]).intValue();
			String rowmodel = row[1].toString();
			String rowmake = row[2].toString();
			Ex12Car ex12Car = new Ex12Car(rowplate, rowmodel, rowmake);
			cars.add(ex12Car);
			System.out.println("ex12Car:" + ex12Car.toString());
		}
		return cars;
